...
import resume from "../media/Chinmay Resume_Front End Developer.pdf";
            ...
            <div className="col-lg-4 col-md-7 col-sm-12">
              <div className="intro container">
                ...
                <div className="resu">
                  <a
                    href={resume}
                    download="Chinmay Resume_Front End Developer.pdf"
                  >
              ...
              <div className="description">
                <div className="heading">
                  ...
                  <span className="greet H2-U">
                    Hey, I'm <span className="sp-name">Chinmay</span>, <br />{" "}
